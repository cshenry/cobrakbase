...
class annotation_ontology_api(object):
    ...
    def _check_job(self, job_id):
        return self._client._check_job('annotation_ontology_api', job_id)

    def _get_annotation_ontology_events_submit(self, params, context=None):
        return self._client._submit_job(
             'annotation_ontology_api.get_annotation_ontology_events', [params],
    ...
    def get_annotation_ontology_events(self, params, context=None):
        ...
        :returns: instance of type "GetAnnotationOntologyEventsOutput" ->
           ...
           of String
        """
        job_id = self._get_annotation_ontology_events_submit(params, context)
    ...
    def _add_annotation_ontology_events_submit(self, params, context=None):
        return self._client._submit_job(
             'annotation_ontology_api.add_annotation_ontology_events', [params],
             self._service_ver, context)
    ...
    def add_annotation_ontology_events(self, params, context=None):
        ...
        """
        job_id = self._add_annotation_ontology_events_submit(params, context)
        async_job_check_time = self._client.async_job_check_time
        while True:
            time.sleep(async_job_check_time)
            async_job_check_time = (async_job_check_time *
    ...
    def _svradmin_submit(self, params, context=None):
        return self._client._submit_job(
             'annotation_ontology_api.svradmin', [params],
             self._service_ver, context)
    ...
    def svradmin(self, params, context=None):
        ...
        """
        job_id = self._svradmin_submit(params, context)
        async_job_check_time = self._client.async_job_check_time
        while True:
            time.sleep(async_job_check_time)
            async_job_check_time = (async_job_check_time *
    ...
    def status(self, context=None):
        job_id = self._client._submit_job('annotation_ontology_api.status', 
            [], self._service_ver, context)
        async_job_check_time = self._client.async_job_check_time
        while True:
            time.sleep(async_job_check_time)
